...
interface BasicModelViewerProps {
  isUnlocked: boolean;
...
function Model({ isUnlocked, onHotspotClick }: BasicModelViewerProps) {
...
export default function BasicModelViewer({ isUnlocked, onHotspotClick }: BasicModelViewerProps) {
  return (
...
useGLTF.preload('/assets/3d objects/3d_artifact.glb');